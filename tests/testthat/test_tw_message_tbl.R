...
test_that("tw_message_tbl() can read in a twilio_messages_list", {
  messages_list <- structure(list(
    structure(list(
      sid = "SM1jtHMmhOCv90MA3XZiMinXbSY94EPVca", date_created = "Mon, 21 Nov 2016 19:45:47 +0000",
    ...
    structure(list(
      sid = "MMH82TU6tVCbGsspcDnvJU47JuTizM3DdE", date_created = "Tue, 15 Nov 2016 15:56:05 +0000",
